# TestMode_Patterns
[![Build status](https://ci.appveyor.com/api/projects/status/o273bcv1i7cs16bh/branch/main?svg=true)](https://ci.appveyor.com/project/Ntetikova/testmode-patterns/branch/main)
...
**Важно**: задача заключается в том, чтобы протестировать функцию входа через веб-интерфейс с использованием Selenide.
